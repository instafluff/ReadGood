**ReadGood** Dyslexia-Friendly Twitch Chat View Using OpenDyslexic Font!
...
You can also add an optional value in the url to ignore !commands:

```
For example:
https://www.instafluff.tv/ReadGood?channel=instafluff&ignoreCommands=true
```
